...
type ExtractParams<TUnion extends {
    method: string;
}, TMethod extends TUnion["method"]> = Extract<TUnion, {
    method: TMethod;
}> extends {
...
export type ClientRequestParams<TMethod extends ClientRequestMethod> = ExtractParams<ClientRequest, TMethod>;
export type ServerNotificationParams<TMethod extends ServerNotificationMethod> = ExtractParams<ServerNotification, TMethod>;
export type ServerRequestParams<TMethod extends ServerRequestMethod> = ExtractParams<ServerRequest, TMethod>;
...
export type ServerRequestResult<TMethod extends ServerRequestMethod> = ServerRequestResultMap[Extract<TMethod, keyof ServerRequestResultMap>];
...
export type ClientCallEnvelope<TMethod extends ClientRequestMethod | ServerRequestMethod = ClientRequestMethod | ServerRequestMethod> = {
    type: "client.call";
    id: RequestId;
    method: TMethod;
    params: TMethod extends ClientRequestMethod ? ClientRequestParams<TMethod> : TMethod extends ServerRequestMethod ? ServerRequestResult<TMethod> : never;
};
...
export type ServerNotificationEnvelope<TMethod extends ServerNotificationMethod | ServerRequestMethod | "server.status" = ServerNotificationMethod | ServerRequestMethod | "server.status"> = TMethod extends "server.status" ? {
